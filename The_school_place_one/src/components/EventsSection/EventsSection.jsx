      ...
      <section className="events_section">
        ...
        <main className="events_section_main_content">
          <article className="events_section_content">
            ...
            <p className="events_section_article_paragraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
eiusmod tempor incididunt ut labore et.
            </p>
            <ul className="events_section_article_tags_wrapper">
                        <li><div className="events_section_article_tags">
          ...
          <div className="events_section_images">
            <img src={Girlinclass} alt="A girl in a classroom" className="girlinclass" />
